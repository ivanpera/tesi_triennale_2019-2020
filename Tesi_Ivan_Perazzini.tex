...
\renewcommand\section{\@startsection{section}{1}{\z@}%
  ...
  \chapter{Sviluppo del DAO}
    ...
    \paragraph*{}
      ...
      \paragraph*{}
      In particolare, i database documentali contengono al loro interno \emph{documenti}, strutture dati tipicamente organizzate internamente come serie di chiavi-valori (ad esempio, implementando i formati JSON, XML o YAML).
    ...
    \subsection{Aggiornamento}
      ...
      \begin{enumerate}
        ...
        \begin{enumerate}
          ...
          \begin{itemize}
            \item nel caso lo sia, tutti i modelli associati al modello in esame tramite quel campo devono essere eliminati e sostituiti con quelli in ingresso: gli id degli elementi da eliminare vengono salvati in una lista, poi vengono inseriti e associati gli elementi del nuovo array.
    ...
    \chapter{Conclusioni}
      ...
      \paragraph*{}
      È stata anche sviluppata una prima versione del DAO astratto, utilizzante la libreria Sequelize, in grado di convertire le richieste in formato SQL.
      ...
      \paragraph*{}
        È stata data considerazione alle prestazioni cercando di minimizzare, dove possibile, il numero di operazioni di JOIN in lettura e massimizzare le scritture in blocco.
      \paragraph*{}
